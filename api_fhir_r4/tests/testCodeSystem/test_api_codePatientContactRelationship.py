...
from insuree.test_helpers import create_test_relation


class CodeSystemPatientContactRelationshipAPITests(
    GenericFhirAPITestMixin, APITestCase
):
    base_url = (
        GeneralConfiguration.get_base_url() + "CodeSystem/patient-contact-relationship/"
    )
