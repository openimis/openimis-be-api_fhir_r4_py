...
class PaymentNoticeTestMixin(GenericTestMixin):
    _TEST_PAYMENT_NOTICE_IMIS_RECONCILIATION_STATUS = (
        PaymentInvoice.ReconciliationStatus.RECONCILIATED
    )
    _TEST_PAYMENT_NOTICE_IMIS_JSON_EXT = {
        "reconciliation": {"id": "id-renconiliation-test-1"}
    }
    ...
    _TEST_PAYMENT_NOTICE_IMIS_DETAILS_STATUS = (
        DetailPaymentInvoice.DetailPaymentStatus.ACCEPTED
    )
    _TEST_PAYMENT_NOTICE_IMIS_DETAILS_PAYMENT = None
    _TEST_PAYMENT_NOTICE_IMIS_DETAILS_SUBJECT_ID = (
        "bd84b2f2-ec1d-48de-8f8c-5a477aa4a29f"
    )
    _TEST_PAYMENT_NOTICE_IMIS_DETAILS_RECON_ID = "id-renconiliation-test-1"

    _TEST_PAYMENT_NOTICE_FHIR_STATUS = "active"
    _TEST_PAYMENT_NOTICE_FHIR_REQUEST_REFERENCE = (
        "Invoice/bd84b2f2-ec1d-48de-8f8c-5a477aa4a29f"
    )
    ...
    _TEST_PAYMENT_NOTICE_FHIR_PAYMENT_REFERENCE = (
        "PaymentReconciliation/id-renconiliation-test-1"
    )
    ...
    def create_test_fhir_instance(self):
        return {
            ...
            "payment": {"reference": self._TEST_PAYMENT_NOTICE_FHIR_PAYMENT_REFERENCE},
            "paymentDate": self._TEST_PAYMENT_NOTICE_IMIS_DATE_PAYMENT,
            "recipient": {"reference": self._TEST_PAYMENT_NOTICE_FHIR_RECIPIENT},
            "amount": {
