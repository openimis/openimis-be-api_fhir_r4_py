...
class ClaimResponseTestMixin(GenericTestMixin):
    ...
    def verify_fhir_instance(self, fhir_obj):
        ...
        self.assertEqual(
            ...
            fhir_obj.item[0].adjudication[0].category.coding[0].code,
        )
        self.assertEqual(
            self._TEST_ITEM_QUANTITY, fhir_obj.item[0].adjudication[0].value
        )
        self.assertEqual(
            self._TEST_ITEM_PRICE, fhir_obj.item[0].adjudication[0].amount.value
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            fhir_obj.item[1].adjudication[0].category.coding[0].code,
        )
        self.assertEqual(
            self._TEST_SERVICE_QUANTITY, fhir_obj.item[1].adjudication[0].value
        )
        self.assertEqual(
            self._TEST_SERVICE_PRICE, fhir_obj.item[1].adjudication[0].amount.value
        )
        self.assertEqual(
        ...
        self.assertEqual(
            str(self._TEST_STATUS), fhir_obj.total[0].category.coding[0].code
        )
        self.assertEqual(self._PRICE_ASKED, fhir_obj.total[0].amount.value)
        self.assertEqual(
            str(self.test_claim_admin.uuid), fhir_obj.requestor.identifier.value
        )
