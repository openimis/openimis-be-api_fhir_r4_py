...
class GroupTestMixin(GenericTestMixin):
    ...
    def setUpTestData(cls):
        ...
        cls.test_insuree = create_test_insuree(
            with_family=False, custom_props={"current_village": cls.test_village}
        )
    ...
    def create_test_fhir_instance(self):
        ...
        extension.valueCodeableConcept = GroupConverter.build_codeable_concept(
            code=str(self._TEST_GROUP_TYPE.code), system=system
        )
        ...
        family_address = GroupConverter.build_fhir_address(
    ...
    def verify_fhir_instance(self, fhir_obj):
        ...
        for identifier in fhir_obj.identifier:
            ...
            code = GroupConverter.get_first_coding_from_codeable_concept(
                identifier.type
            ).code
        ...
        if False:  # FIXME
            ...
            for extension in fhir_obj.extension:
                ...
                if "group-address" in extension.url:
                    ...
                    self.assertEqual(
                        self._TEST_VILLAGE_NAME, extension.valueAddress.city
                    )
