...
class ActivityDefinitionTestMixin(GenericTestMixin, FhirConverterTestMixin):
    ...
    def create_test_fhir_instance(self):
        ...
        fhir_activity_definition.resource_type = (
            self._TEST_ACTIVITY_DEFINITION_RESOURCE_TYPE
        )
        ...
        topic_coding.system = ServiceTypeMapping.fhir_service_type_coding[
            self._TEST_SERVICE_TYPE
        ]["system"]
        topic_coding.code = ServiceTypeMapping.fhir_service_type_coding[
            self._TEST_SERVICE_TYPE
        ]["code"]
        topic_coding.display = ServiceTypeMapping.fhir_service_type_coding[
            self._TEST_SERVICE_TYPE
        ]["display"]
        ...
        gender_coding.system = UseContextMapping.fhir_use_context_coding["gender"][
            "system"
        ]
        gender_coding.code = UseContextMapping.fhir_use_context_coding["gender"]["code"]
        gender_coding.display = UseContextMapping.fhir_use_context_coding["gender"][
            "display"
        ]
        male_coding = Coding.construct()
        male_coding.system = PatientCategoryMapping.fhir_patient_category_coding[
            "male"
        ]["system"]
        male_coding.code = PatientCategoryMapping.fhir_patient_category_coding["male"][
            "code"
        ]
        male_coding.display = PatientCategoryMapping.fhir_patient_category_coding[
            "male"
        ]["display"]
        female_coding = Coding.construct()
        female_coding.system = PatientCategoryMapping.fhir_patient_category_coding[
            "female"
        ]["system"]
        female_coding.code = PatientCategoryMapping.fhir_patient_category_coding[
            "female"
        ]["code"]
        female_coding.display = PatientCategoryMapping.fhir_patient_category_coding[
            "female"
        ]["display"]
        ...
        child_coding.system = PatientCategoryMapping.fhir_patient_category_coding[
            "child"
        ]["system"]
        child_coding.code = PatientCategoryMapping.fhir_patient_category_coding[
            "child"
        ]["code"]
        child_coding.display = PatientCategoryMapping.fhir_patient_category_coding[
            "child"
        ]["display"]
        adult_coding = Coding.construct()
        adult_coding.system = PatientCategoryMapping.fhir_patient_category_coding[
            "adult"
        ]["system"]
        adult_coding.code = PatientCategoryMapping.fhir_patient_category_coding[
            "adult"
        ]["code"]
        adult_coding.display = PatientCategoryMapping.fhir_patient_category_coding[
            "adult"
        ]["display"]
        ...
        venue_coding.system = UseContextMapping.fhir_use_context_coding["venue"][
            "system"
        ]
        venue_coding.code = UseContextMapping.fhir_use_context_coding["venue"]["code"]
        venue_coding.display = UseContextMapping.fhir_use_context_coding["venue"][
            "display"
        ]
        amb_coding = Coding.construct()
        amb_coding.system = VenueMapping.fhir_venue_coding[
            Service.CARE_TYPE_OUT_PATIENT
        ]["system"]
        amb_coding.code = VenueMapping.fhir_venue_coding[Service.CARE_TYPE_OUT_PATIENT][
            "code"
        ]
        amb_coding.display = VenueMapping.fhir_venue_coding[
            Service.CARE_TYPE_OUT_PATIENT
        ]["display"]
        imp_coding = Coding.construct()
        imp_coding.system = VenueMapping.fhir_venue_coding[
            Service.CARE_TYPE_IN_PATIENT
        ]["system"]
        imp_coding.code = VenueMapping.fhir_venue_coding[Service.CARE_TYPE_IN_PATIENT][
            "code"
        ]
        imp_coding.display = VenueMapping.fhir_venue_coding[
            Service.CARE_TYPE_IN_PATIENT
        ]["display"]
        ...
        workflow_coding.system = UseContextMapping.fhir_use_context_coding["workflow"][
            "system"
        ]
        workflow_coding.code = UseContextMapping.fhir_use_context_coding["workflow"][
            "code"
        ]
        workflow_coding.display = UseContextMapping.fhir_use_context_coding["workflow"][
            "display"
        ]
        antenatal_coding = Coding.construct()
        antenatal_coding.system = WorkflowMapping.fhir_workflow_coding[
            Service.CATEGORY_ANTENATAL
        ]["system"]
        antenatal_coding.code = WorkflowMapping.fhir_workflow_coding[
            Service.CATEGORY_ANTENATAL
        ]["code"]
        antenatal_coding.display = WorkflowMapping.fhir_workflow_coding[
            Service.CATEGORY_ANTENATAL
        ]["display"]
        ...
        fhir_activity_definition.useContext = [
            gender_usage_context,
            age_usage_context,
            venue_usage_context,
    ...
    def verify_fhir_instance(self, fhir_obj):
        ...
        self.assertEqual(
            fhir_obj.resource_type, self._TEST_ACTIVITY_DEFINITION_RESOURCE_TYPE
        )
        ...
        self.verify_fhir_identifier(
            fhir_obj,
            R4IdentifierConfig.get_fhir_uuid_type_code(),
            self._TEST_SERVICE_UUID,
        )
        self.verify_fhir_identifier(
            fhir_obj,
        ...
        self.assertEqual(
            timing_repeat.frequency, self._TEST_ACTIVITY_DEFINITION_TIMING_FREQUENCY
        )
        self.assertEqual(
            timing_repeat.periodUnit, self._TEST_ACTIVITY_DEFINITION_TIMING_UNIT
        )
        self.assertEqual(timing_repeat.period, self._TEST_SERVICE_FREQUENCY)
        self.verify_fhir_use_context(
            fhir_obj,
            UseContextMapping.fhir_use_context_coding["gender"],
            [
        ...
        self.verify_fhir_use_context(
            fhir_obj,
            UseContextMapping.fhir_use_context_coding["age"],
            [
        ...
        self.verify_fhir_use_context(
            fhir_obj,
            UseContextMapping.fhir_use_context_coding["workflow"],
            [WorkflowMapping.fhir_workflow_coding[self._TEST_SERVICE_CATEGORY]],
        )
        self.verify_fhir_use_context(
            fhir_obj,
            UseContextMapping.fhir_use_context_coding["venue"],
            [
    ...
    def verify_fhir_use_context(
        self, fhir_obj, use_context_type, expected_use_contexts
    ):
        if len(expected_use_contexts) > 0:
            use_contexts = [
                use_context
                for use_context in fhir_obj.useContext
            ...
            for use_context in expected_use_contexts:
                use_context_coding = [
                    coding for coding in codings if coding.code == use_context["code"]
                ]
