...
class CodeSystemOpenIMISMedicalItemViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        if not request.user.has_perms(FHIRApiMedicationPermissions.permissions_get):
        ...
        serializer = CodeSystemSerializer(
            ...
            **{
                ...
                "name": "MedicalItemCS",
                "title": "Medical Item",
                "description": "Indicates the medical items available in openIMIS. "
