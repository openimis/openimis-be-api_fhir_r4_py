...
class CodeSystemOpenIMISMedicalServiceViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        if not request.user.has_perms(FHIRApiActivityDefinitionPermissions.permissions_get):
        ...
        serializer = CodeSystemSerializer(
            ...
            **{
                ...
                "display_field": "name",
                "id": "medical-service",
                "name": "MedicalServiceCS",
                "title": "Medical Service",
                "description": "Indicates the medical services available in openIMIS. "
