...
class EnrolmentOfficerPractitionerConverter(
    ...
    def to_imis_obj(cls, fhir_practitioner, audit_user_id):
        ...
        imis_officer = EnrolmentOfficerPractitionerConverter.create_default_claim_admin(
            audit_user_id
        )
    ...
    def build_imis_identifiers(cls, imis_officer, fhir_practitioner, errors):
        ...
        cls.valid_condition(
            imis_officer.code is None, _("Missing the claim admin code"), errors
        )
    ...
    def build_imis_names(cls, imis_officer, fhir_practitioner):
        ...
        imis_officer.last_name, imis_officer.other_names = (
    ...
    def build_imis_contacts(cls, imis_officer, fhir_practitioner):
        imis_officer.phone, imis_officer.email = cls.build_imis_phone_num_and_email(
            fhir_practitioner.telecom
        )
