...
class IdentifierConfiguration(BaseConfiguration):  # pragma: no cover
    ...
    def get_fhir_identifier_type_system(cls):
        raise NotImplementedError(
            "`get_fhir_identifier_type_system()` must be implemented."
        )
    ...
    def get_fhir_passport_type_code(cls):
        raise NotImplementedError(
            "`get_fhir_passport_type_code()` must be implemented."
        )
    ...
    def get_fhir_claim_admin_code_type(cls):
        raise NotImplementedError(
            "`get_fhir_claim_admin_code_type()` must be implemented."
        )
...
class LocationConfiguration(BaseConfiguration):  # pragma: no cover
    ...
    def get_fhir_location_site_type_system(cls):
        raise NotImplementedError(
            "`get_fhir_location_site_type_system()` must be implemented."
        )
    ...
    def get_fhir_code_for_dispensary(cls):
        raise NotImplementedError(
            "`get_fhir_code_for_dispensary()` must be implemented."
        )

    @classmethod
    def get_fhir_code_for_health_center(cls):
        raise NotImplementedError(
            "`get_fhir_code_for_health_center()` must be implemented."
        )

    @classmethod
    def get_fhir_location_physical_type_system(cls):
        raise NotImplementedError(
            "`get_fhir_location_physical_type_system()` must be implemented."
        )
    ...
    def get_fhir_hf_service_type_system(cls):
        raise NotImplementedError(
            "`get_fhir_hf_service_type_system()` must be implemented"
        )

    @classmethod
    def get_fhir_code_for_in_patient(cls):
        raise NotImplementedError(
            "`get_fhir_code_for_in_patient()` must be implemented"
        )

    @classmethod
    def get_fhir_code_for_out_patient(cls):
        raise NotImplementedError(
            "`get_fhir_code_for_out_patient()` must be implemented"
        )
    ...
    def get_subscribe_location_signal(cls):
        raise NotImplementedError(
            "`get_subscribe_location_signal()` must be implemented"
        )
...
class MaritalConfiguration(BaseConfiguration):  # pragma: no cover
    ...
    def get_fhir_marital_status_system(cls):
        raise NotImplementedError(
            "`get_fhir_marital_status_system()` must be implemented."
        )
    ...
    def get_fhir_never_married_code(cls):
        raise NotImplementedError(
            "`get_fhir_never_married_code()` must be implemented."
        )
    ...
    def get_fhir_unknown_marital_status_code(cls):
        raise NotImplementedError(
            "`get_fhir_unknown_marital_status_code()` must be implemented."
        )
...
class IssueTypeConfiguration(BaseConfiguration):  # pragma: no cover
    ...
    def get_fhir_code_for_exception(cls):
        raise NotImplementedError(
            "`get_fhir_code_for_exception()` must be implemented."
        )

    @classmethod
    def get_fhir_code_for_not_found(cls):
        raise NotImplementedError(
            "`get_fhir_code_for_not_found()` must be implemented."
        )

    @classmethod
    def get_fhir_code_for_informational(cls):
        raise NotImplementedError(
            "`get_fhir_code_for_informational()` must be implemented."
        )

    @classmethod
    def get_fhir_claim_item_general_adjudication_code(cls):
        raise NotImplementedError(
            "`get_fhir_claim_item_general_adjudication_code()` must be implemented."
        )

    @classmethod
    def get_fhir_claim_item_rejected_reason_adjudication_code(cls):
        raise NotImplementedError(
            "`get_fhir_claim_item_rejected_reason_adjudication_code()` must be implemented."
        )
...
class ClaimConfiguration(BaseConfiguration):  # pragma: no cover
    ...
    def get_fhir_claim_information_guarantee_id_code(cls):
        raise NotImplementedError(
            "`get_fhir_claim_information_guarantee_id_code()` must be implemented."
        )

    @classmethod
    def get_fhir_claim_information_explanation_code(cls):
        raise NotImplementedError(
            "`get_fhir_claim_information_explanation_code()` must be implemented."
        )

    @classmethod
    def get_fhir_claim_item_explanation_code(cls):
        raise NotImplementedError(
            "`get_fhir_claim_item_explanation_code()` must be implemented."
        )
    ...
    def get_fhir_claim_service_code(cls):
        raise NotImplementedError(
            "`get_fhir_claim_service_code()` must be implemented."
        )

    @classmethod
    def get_fhir_claim_status_rejected_code(cls):
        raise NotImplementedError(
            "`get_fhir_claim_status_rejected_code()` must be implemented."
        )

    @classmethod
    def get_fhir_claim_status_entered_code(cls):
        raise NotImplementedError(
            "`get_fhir_claim_status_entered_code()` must be implemented."
        )

    @classmethod
    def get_fhir_claim_status_checked_code(cls):
        raise NotImplementedError(
            "`get_fhir_claim_status_checked_code()` must be implemented."
        )

    @classmethod
    def get_fhir_claim_status_processed_code(cls):
        raise NotImplementedError(
            "`get_fhir_claim_status_processed_code()` must be implemented."
        )

    @classmethod
    def get_fhir_claim_status_valuated_code(cls):
        raise NotImplementedError(
            "`get_fhir_claim_status_valuated_code()` must be implemented."
        )

    @classmethod
    def get_fhir_claim_item_status_passed_code(cls):
        raise NotImplementedError(
            "`get_fhir_claim_item_status_passed_code()` must be implemented."
        )

    @classmethod
    def get_fhir_claim_item_status_rejected_code(cls):
        raise NotImplementedError(
            "`get_fhir_claim_item_status_rejected_code()` must be implemented."
        )
    ...
    def get_fhir_claim_organization_code(cls):
        raise NotImplementedError(
            "`get_fhir_claim_organization_code()` must be implemented."
        )

    @classmethod
    def get_fhir_claim_attachment_code(cls):
        raise NotImplementedError(
            "`get_fhir_claim_attachment_code()` must be implemented."
        )

    @classmethod
    def get_fhir_claim_visit_type_system(cls):
        raise NotImplementedError(
            "`get_fhir_claim_visit_type_system()` must be implemented."
        )

    @classmethod
    def get_fhir_claim_supporting_info_system(cls):
        raise NotImplementedError(
            "`get_fhir_claim_supporting_info_system()` must be implemented."
        )

    @classmethod
    def get_fhir_item_reference_extension_system(cls):
        raise NotImplementedError(
            "`get_fhir_item_reference_extension_system()` must be implemented."
        )

    @classmethod
    def get_fhir_claim_item_category_system(cls):
        raise NotImplementedError(
            "`get_fhir_claim_item_category_system()` must be implemented."
        )

    @classmethod
    def get_fhir_claim_diagnosis_system(cls):
        raise NotImplementedError(
            "`get_fhir_claim_diagnosis_system()` must be implemented."
        )

    @classmethod
    def get_fhir_claim_attachment_system(cls):
        raise NotImplementedError(
            "`get_fhir_claim_attachment_system()` must be implemented."
        )

    @classmethod
    def get_allowed_fhir_claim_attachment_mime_types_regex(cls):
        raise NotImplementedError(
            "`get_allowed_fhir_claim_attachment_mime_types_regex()` must be implemented."
        )
...
class CoverageEligibilityConfiguration(BaseConfiguration):  # pragma: no cover
    ...
    def get_fhir_total_admissions_code(cls):
        raise NotImplementedError(
            "`get_fhir_total_admissions_code()` must be implemented."
        )
    ...
    def get_fhir_total_consultations_code(cls):
        raise NotImplementedError(
            "`get_fhir_total_consultations_code()` must be implemented."
        )

    @classmethod
    def get_fhir_total_surgeries_code(cls):
        raise NotImplementedError(
            "`get_fhir_total_surgeries_code()` must be implemented."
        )

    @classmethod
    def get_fhir_total_deliveries_code(cls):
        raise NotImplementedError(
            "`get_fhir_total_deliveries_code()` must be implemented."
        )

    @classmethod
    def get_fhir_total_antenatal_code(cls):
        raise NotImplementedError(
            "`get_fhir_total_antenatal_code()` must be implemented."
        )

    @classmethod
    def get_fhir_consultation_amount_code(cls):
        raise NotImplementedError(
            "`get_fhir_consultation_amount_code()` must be implemented."
        )

    @classmethod
    def get_fhir_surgery_amount_code(cls):
        raise NotImplementedError(
            "`get_fhir_surgery_amount_code()` must be implemented."
        )

    @classmethod
    def get_fhir_delivery_amount_code(cls):
        raise NotImplementedError(
            "`get_fhir_delivery_amount_code()` must be implemented."
        )

    @classmethod
    def get_fhir_hospitalization_amount_code(cls):
        raise NotImplementedError(
            "`get_fhir_hospitalization_amount_code()` must be implemented."
        )

    @classmethod
    def get_fhir_antenatal_amount_code(cls):
        raise NotImplementedError(
            "`get_fhir_antenatal_amount_code()` must be implemented."
        )
    ...
    def get_fhir_is_service_ok_code(cls):
        raise NotImplementedError(
            "`get_fhir_is_service_ok_code()` must be implemented."
        )
    ...
    def get_fhir_balance_default_category(cls):
        raise NotImplementedError(
            "`get_fhir_balance_default_category()` must be implemented."
        )
...
class CommunicationRequestConfiguration(BaseConfiguration):  # pragma: no cover
    ...
    def get_fhir_care_rendered_code(cls):
        raise NotImplementedError(
            "`get_fhir_care_rendered_code()` must be implemented."
        )

    @classmethod
    def get_fhir_payment_asked_code(cls):
        raise NotImplementedError(
            "`get_fhir_payment_asked_code()` must be implemented."
        )

    @classmethod
    def get_fhir_drug_prescribed_code(cls):
        raise NotImplementedError(
            "`get_fhir_drug_prescribed_code()` must be implemented."
        )
...
class InvoiceConfiguration(BaseConfiguration):
    ...
    def get_fhir_invoice_type_system(cls):
        raise NotImplementedError(
            "`get_fhir_invoice_type_system()` must be implemented."
        )

    @classmethod
    def get_fhir_invoice_charge_item_system(cls):
        raise NotImplementedError(
            "`get_fhir_invoice_charge_item_system()` must be implemented."
        )
    ...
    def get_subscribe_invoice_signal(cls):
        raise NotImplementedError(
            "`get_subscribe_invoice_signal()` must be implemented"
        )
...
class OrganisationConfiguration(BaseConfiguration):
    ...
    def get_fhir_ph_organisation_type(cls):
        raise NotImplementedError(
            "`get_fhir_ph_organisation_type()` must be implemented."
        )

    @classmethod
    def get_fhir_address_municipality_extension_system(cls):
        raise NotImplementedError(
            "`get_fhir_address_municipality_extension_system()` must be implemented."
        )

    @classmethod
    def get_fhir_location_reference_extension_system(cls):
        raise NotImplementedError(
            "`get_fhir_location_reference_extension_system()` must be implemented."
        )

    @classmethod
    def get_fhir_ph_organisation_legal_form_extension_system(cls):
        raise NotImplementedError(
            "`get_fhir_ph_organisation_legal_form_extension_system()` must be implemented."
        )

    @classmethod
    def get_fhir_ph_organisation_activity_extension_system(cls):
        raise NotImplementedError(
            "`get_fhir_ph_organisation_activity_extension_system()` must be implemented."
        )

    @classmethod
    def get_fhir_ph_organisation_legal_form_code_system(cls):
        raise NotImplementedError(
            "`get_fhir_ph_organisation_legal_form_code_system()` must be implemented."
        )

    @classmethod
    def get_fhir_ph_organisation_activity_code_system(cls):
        raise NotImplementedError(
            "`get_fhir_ph_organisation_activity_code_system()` must be implemented."
        )

    @classmethod
    def get_fhir_ph_organisation_type_system(cls):
        raise NotImplementedError(
            "`get_fhir_ph_organisation_type_system()` must be implemented."
        )
...
class SubscriptionConfiguration(BaseConfiguration):
    ...
    def get_fhir_subscription_channel_rest_hook(cls):
        raise NotImplementedError(
            "`get_fhir_subscription_channel_rest_hook()` must be implemented."
        )

    @classmethod
    def get_fhir_subscription_status_off(cls):
        raise NotImplementedError(
            "`get_fhir_subscription_status_off()` must be implemented."
        )

    @classmethod
    def get_fhir_subscription_status_active(cls):
        raise NotImplementedError(
            "`get_fhir_subscription_status_active()` must be implemented."
        )

    @classmethod
    def get_fhir_sub_criteria_key_resource(cls):
        raise NotImplementedError(
            "`get_fhir_sub_criteria_key_resource()` must be implemented."
        )

    @classmethod
    def get_fhir_sub_criteria_key_resource_type(cls):
        raise NotImplementedError(
            "`get_fhir_sub_criteria_key_resource_type()` must be implemented."
        )
...
class PaymentNoticeConfiguration(BaseConfiguration):
    ...
    def get_fhir_payment_notice_status_active(cls):
        raise NotImplementedError(
            "`get_fhir_payment_notice_status_active()` must be implemented."
        )

    @classmethod
    def get_fhir_payment_notice_status_cancelled(cls):
        raise NotImplementedError(
            "`get_fhir_payment_notice_status_cancelled()` must be implemented."
        )

    @classmethod
    def get_fhir_payment_notice_status_draft(cls):
        raise NotImplementedError(
            "`get_fhir_payment_notice_status_draft()` must be implemented."
        )

    @classmethod
    def get_fhir_payment_notice_status_entered_in_error(cls):
        raise NotImplementedError(
            "`get_fhir_payment_notice_status_entered_in_error()` must be implemented."
        )

    @classmethod
    def get_fhir_payment_notice_payment_status_paid(cls):
        raise NotImplementedError(
            "`get_fhir_payment_notice_payment_status_paid()` must be implemented."
        )

    @classmethod
    def get_fhir_payment_notice_payment_status_cleared(cls):
        raise NotImplementedError(
            "`get_fhir_payment_notice_payment_status_cleared()` must be implemented."
        )
...
class BaseApiFhirConfiguration(BaseConfiguration):  # pragma: no cover
    ...
    def get_identifier_configuration(cls):
        raise NotImplementedError(
            "`get_identifier_configuration()` must be implemented."
        )

    @classmethod
    def get_location_type_configuration(cls):
        raise NotImplementedError(
            "`get_location_type_configuration()` must be implemented."
        )

    @classmethod
    def get_marital_type_configuration(cls):
        raise NotImplementedError(
            "`get_marital_type_configuration()` must be implemented."
        )

    @classmethod
    def get_issue_type_configuration(cls):
        raise NotImplementedError(
            "`get_issue_type_configuration()` must be implemented."
        )
    ...
    def get_coverage_eligibility_configuration(cls):
        raise NotImplementedError(
            "`get_coverage_eligibility_configuration()` must be implemented."
        )

    @classmethod
    def get_communication_request_configuration(cls):
        raise NotImplementedError(
            "`get_communication_request_configuration()` must be implemented."
        )
    ...
    def get_organisation_configuration(cls):
        raise NotImplementedError(
            "`get_organisation_configuration()` must be implemented."
        )

    @classmethod
    def get_subscription_configuration(cls):
        raise NotImplementedError(
            "`get_subscription_configuration()` must be implemented."
        )

    @classmethod
    def get_payment_notice_configuration(cls):
        raise NotImplementedError(
            "`get_payment_notice_configuration()` must be implemented."
        )
