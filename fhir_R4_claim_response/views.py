...
class ClaimResponseViewSet(
    ...
    """
    FHIR ClaimResponse Resource ViewSet
    Maps openIMIS Claim to FHIR ClaimResponse resource
    """
    ...
    def list(self, request, *args, **kwargs):
        ...
        serializer = ClaimResponseSerializer(self.paginate_queryset(queryset), many=True, user=request.user)
