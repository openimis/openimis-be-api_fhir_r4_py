...
class CoverageViewSet(BaseFHIRView, RetrieveModelMixin, ListModelMixin, GenericViewSet):
    """
    FHIR Coverage Resource ViewSet
    Maps openIMIS Policy to FHIR Coverage resource
    """
    lookup_field = 'uuid'
